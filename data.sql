...
(1, '秋季', 2023, 1, '[1, 3]', 11),   -- 周一1-2节+周二1-2节
(2, '秋季', 2023, 3, '[2, 4]', 12),   -- 周一3-4节+周二3-4节
(3, '秋季', 2023, 2, '[5]', 13),      -- 周三1-2节
(4, '秋季', 2023, 5, '[7]', 14),      -- 周四3-4节
(5, '秋季', 2023, 4, '[8]', 15),      -- 周四5-6节
(6, '春季', 2024, 6, '[6]', 16),      -- 周三5-6节
(7, '春季', 2024, 7, '[9]', 17),      -- 周五1-2节
(8, '春季', 2024, 8, '[10]', 18),     -- 周五3-4节
(9, '春季', 2024, 10, '[3]', 19),     -- 周二1-2节
(10, '秋季', 2023, 1, '[1, 5]', 11),  -- 周一1-2节+周三1-2节
(11, '春季', 2024, 4, '[4, 9]', 11);  -- 周二3-4节+周五1-2节
