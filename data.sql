...
INSERT INTO section (course_id, semester, `year`, classroom_id, time_slot_ids, teacher_id,time) VALUES
                                                                                               ...
                                                                                               (3, '秋季', 2023, 2, '[5]', 13,1),      -- 周三1-2节
                                                                                               (4, '秋季', 2023, 5, '[7]', 14,1),      -- 周四3-4节
                                                                                               (5, '秋季', 2023, 4, '[8]', 15,1),      -- 周四5-6节
                                                                                               (6, '春季', 2024, 6, '[6]', 16,1),      -- 周三5-6节
                                                                                               (7, '春季', 2024, 7, '[9]', 17,1),      -- 周五1-2节
                                                                                               (8, '春季', 2024, 8, '[10]', 18,1),     -- 周五3-4节
                                                                                               (9, '春季', 2024, 10, '[3]', 19,1),     -- 周二1-2节
